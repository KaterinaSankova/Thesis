...
\begin{figure}[H]
    ...
    \leavevmode\newline
        ...
        \end{subfigure}
    \end{example}
    \caption{Příklad nearest-addition algoritmu}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
		...
		\end{tikzpicture}
    \end{center}
    \caption{Těsný příklad nearest-addition algoritmu}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
		...
		\end{tikzpicture}
    \end{center}
    \caption{Těsný příklad nearest-addition algoritmu - cesty}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
		...
		\end{tikzpicture}
    \end{center}
    \caption{Těsný příklad nearest-addition algoritmu - chod algoritmu}
\end{figure}

\pagebreak
\subsection{Algoritmus double-tree}
...
\begin{figure}[H]
    \begin{center}
		\begin{tikzpicture}[scale=0.7]
 	 		...
 	 		\draw (t0) -- (t5);
		\end{tikzpicture}
    \caption{Těsný příklad algoritmu double-tree - minimální kostra}
    \end{center}
\end{figure}
...
\subsection{Christofidesův algoritmus}
...
\begin{center}
	...
	\end{tikzpicture}
\end{center}
\caption{Sekvenční hledání hran}\leavevmode\newline
\end{figure}
