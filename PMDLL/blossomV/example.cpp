...
void LoadFile(int& node_num, int& edge_num, int*& edges, double*& weights, char* filename)
{
	int e = 0;
	char LINE[1000];
...
int main(int argc, char* argv[])
{
	...
	int* edges = {}; //doplnìna inicializace
	double* weights = {};//doplnìna inicializace
