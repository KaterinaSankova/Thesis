...
namespace TSP.Sections
{
    public class InputSection : Grid
    {
        ...
        public string SourcePath
        {
            get
            {
                if (mode == InputMode.File)
                    return sourceFilePicker.FilePath;
                else if (mode == InputMode.Folder)
                    return sourceFolderPicker.FolderPath;
                else
        ...
        public string ResultPath
        {
            ...
            {
                if (mode == InputMode.File)
                    return resultFilePicker.FilePath;
                else if (mode == InputMode.Folder)
                    return resultFolderPicker.FolderPath;
                else
        ...
        public int NumberOfSamples
        {
            get
            {
                ...
                {
                    int numberOfSamples;
                    int.TryParse(numberOfSamplesInput.Text, out numberOfSamples);
        ...
        public int NumberOfCitites
        {
            get
            {
                ...
                {
                    int numberOfCities;
                    int.TryParse(numberOfCitiesInput.Text, out numberOfCities);
        ...
        public (double LowestX, double HighestX, double LowestY, double HighestY) ExtremeCoordinateValues
        {
            get
            {
                if (mode == InputMode.Generate)
                {
                    ...
                    double.TryParse(((TextBox)((LabeledElement)extremeCoordinatesValuesInput.Children[0]).Children[1]).Text, out lowestX);
                    double.TryParse(((TextBox)((LabeledElement)extremeCoordinatesValuesInput.Children[1]).Children[1]).Text, out highestX);
                    double.TryParse(((TextBox)((LabeledElement)extremeCoordinatesValuesInput.Children[2]).Children[1]).Text, out lowestY);
                    double.TryParse(((TextBox)((LabeledElement)extremeCoordinatesValuesInput.Children[3]).Children[1]).Text, out highestY);
