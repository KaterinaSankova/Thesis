using SVGTravellingSalesmanProblem.Algorithms.Enums;
using SVGTravellingSalesmanProblem.Algorithms.Enums.TSPLib;
using SVGTravellingSalesmanProblem.GraphStructures;
using Type = SVGTravellingSalesmanProblem.Algorithms.Enums.TSPLib.Type;
using EdgeWeightType = SVGTravellingSalesmanProblem.Algorithms.Enums.TSPLib.EdgeWeightType;
using System.Text;

namespace SVGTravellingSalesmanProblem.Formats.TSPLib
{
    public class TSPLib
    {
        //the file format
