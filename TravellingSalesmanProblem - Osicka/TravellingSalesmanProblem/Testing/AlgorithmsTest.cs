...
namespace TravellingSalesmanProblem.Testing
{
    public class AlgorithmsTest
    {
        ...
        NearestAddition nearestAddition = new();
        DoubleTree doubleTree = new();
        Christofides christofides = new();
        KernighanLin kernighanLin = new();

        //public Test(string dataFile, string tourFile, TSPAlgorithms algorithm) //
        //{
        ...
        private float GetApproximationFactor(TSPAlgorithms algorithm)
        {
            switch (algorithm)
            {
